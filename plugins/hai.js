...
let helloarie = fs.readFileSync('./mp3/hai.opus') 
...
handler.customPrefix = /^(hi|hii|hiii|hi aine|hii aine|hiii aine|hy|hallo|helo|hello|hai|hy bot|halo bot|hallo bot|helo bot|hello bot|p)$/i
